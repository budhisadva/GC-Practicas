...
int main() {
  ...
  initPixels(BLANCO);
  pinta(vertices_vp[0].getX(), vertices_vp[0].getY(), NEGRO);
  pinta(vertices_vp[1].getX(), vertices_vp[1].getY(), NEGRO);
  pinta(vertices_vp[2].getX(), vertices_vp[2].getY(), NEGRO);
  pinta(vertices_vp[3].getX(), vertices_vp[3].getY(), NEGRO);
  pinta(vertices_vp[4].getX(), vertices_vp[4].getY(), NEGRO);
  pinta(vertices_vp[5].getX(), vertices_vp[5].getY(), NEGRO);
  pinta(vertices_vp[6].getX(), vertices_vp[6].getY(), NEGRO);
  pinta(vertices_vp[7].getX(), vertices_vp[7].getY(), NEGRO);
  //
